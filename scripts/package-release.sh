...
BEANVAN_VERSION="$version" BEANVAN_BUILD_NUMBER="$build_number" \
    "$script_dir/build-app.sh" release >/dev/null

app_path="$dist_dir/Beanvan.app"
binary_path="$app_path/Contents/MacOS/Beanvan"
...
archive_name="Beanvan-${version}-macos-arm64.zip"
