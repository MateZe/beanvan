...
archive_path="${3:-$project_dir/dist/Beanvan-${version}-macos-arm64.zip}"
template_path="$project_dir/packaging/Casks/beanvan.rb.template"
output_path="$project_dir/dist/beanvan.rb"
